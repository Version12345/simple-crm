...
export const ManageFields: React.FC<{ onFieldsChanged: () => void }> = ({ onFieldsChanged }) => {
    ...
    const [newFieldEntity, setNewFieldEntity] = useState("opportunity");
    ...
    return (
        <div className="rounded shadow-lg p-4 mb-4 border border-gray-200">
            <h2 className="text-xl font-bold mb-4 w-100">Manage Custom Fields</h2>
            <div className="mb-6">
                        ...
                        {fields.map(field => (
                            <li key={field.id} className="flex justify-between items-center p-2 bg-gray-100 rounded">
                                <div>
                                    ...
                                    <span className="text-gray-400 text-xs ml-2">[{field.entity || "opportunity"} · {field.type || "text"}]</span>
                                </div>
                                <button
